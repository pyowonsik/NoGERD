        ...
        children: [
          Expanded(
            child: Row(
              ...
              children: [
                _buildChartBar(['4/10', 1, 1, 1]),
                _buildChartBar(['4/11', 1, 1, 1]),
                _buildChartBar(['4/12', 1, 1, 1]),
                _buildChartBar(['4/13', 1, 1, 1]),
                _buildChartBar(['4/14', 1, 1, 1]),
                _buildChartBar(['4/15', 1, 1, 1]),
                _buildChartBar(['4/16', 1, 1, 1]),
              ],
            ),
          ),
